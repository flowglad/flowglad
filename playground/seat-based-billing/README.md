# Flowglad Seat-Based Billing Playground

An example of how to integrate Flowglad into a Next.js project with BetterAuth.
This project demonstrates seat-based billing (work in progress).
...
**Important:** This project is part of a monorepo. You must install dependencies from the root of the monorepo first, then navigate into this directory.
...
```bash
cd playground/seat-based-billing
```
