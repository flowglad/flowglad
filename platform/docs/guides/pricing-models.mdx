...
[Next.js](/guides/nextjs/generation-based-subscription) | [Tanstack Start](/guides/tanstack-start/generation-based-subscription) | [Vite](/guides/vite/generation-based-subscription) | [React Native](/guides/react-native/generation-based-subscription)
...
<CardGroup cols={2}>
  ...
  <Card title="View a Vite Example" icon="/images/vite.svg" href="/guides/vite/generation-based-subscription">
