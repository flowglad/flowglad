...
In your server's Flowglad route handler (at `/api/flowglad/:subroute`), implement the subroute handlers.

**GET /customers/billing**
...
- use the `findOrCreateCustomerBilling` helper to get the customer billing data, and return

**POST /checkout-sessions/create**

**/checkout-sessions/create-add-payment-method**

**/checkout-sessions/create-activate-subscription**
