...
Accessing a customer's purchase history lets you tailor onboarding, upsell paths, and support flows. Flowglad provides past purchases and active [subscriptions](/features/subscriptions) for easy consumption.
