...
- **Generation-based Subscription** - Next.js app with authentication and billing, demonstrating a pricing model with subscription, single-payment, and usage ([examples/generation-based-subscription](https://github.com/flowglad/flowglad/tree/main/examples/generation-based-subscription))
