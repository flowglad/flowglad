...
<CardGroup cols={2}>
  ...
  <Card title="Express Integration" icon="node" href="/sdks/express">
    Express middleware and route handlers (via @flowglad/server/express)
  </Card>
</CardGroup>
...
- ~~[@flowglad/express](https://www.npmjs.com/package/@flowglad/express)~~ (deprecated, use `@flowglad/server/express` instead)
