...
<CardGroup cols={2}>
  <Card title="Pricing Models & Products" icon="book">
    Display your products and pricing models to help customers discover offerings.
  </Card>
  <Card title="Checkout Sessions" icon="shopping-cart">
    Create frictionless checkout sessions with Flowglad-hosted or embedded payment flows.
  </Card>
  <Card title="Subscription Management" icon="refresh">
    Manage subscriptions end-to-end: create them server-side and cancel from either server or client experiences.
  </Card>
  <Card title="Feature Access & Usage" icon="shield">
    Check feature entitlements and monitor usage balances to power gated or usage-based products.
  </Card>
  <Card title="Customer Purchases" icon="user">
...
- @flowglad/react provides UI components and hooks
- @flowglad/server handles backend communication

### For Express Applications

Use **@flowglad/express** + **@flowglad/server**:
- @flowglad/express provides Express-specific middleware
- @flowglad/server handles core functionality
...
- [@flowglad/shared](https://www.npmjs.com/package/@flowglad/shared)
- [@flowglad/types](https://www.npmjs.com/package/@flowglad/types)
- [@flowglad/node](https://www.npmjs.com/package/@flowglad/node)
- [@flowglad/node-mcp](https://www.npmjs.com/package/@flowglad/node-mcp)

## Example Projects

Looking for a complete example? Check out our playground projects:

- **Supabase Auth Example** - Full Next.js app with authentication and billing ([playground/supabase-auth](https://github.com/flowglad/flowglad/tree/main/playground/supabase-auth))
- **Express Example** - Express server with Flowglad integration ([playground/express](https://github.com/flowglad/flowglad/tree/main/playground/express))
