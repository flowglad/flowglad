---
title: "Setup"
description: "Setup instructions for Flowglad Next.js and React SDKs. Read [choosing the right SDK](/sdks/introduction#choosing-the-right-sdk) first, then follow the framework-specific steps below."
---
