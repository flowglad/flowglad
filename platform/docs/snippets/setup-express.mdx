...
```bash yarn
yarn add @flowglad/server express
```
...
<Note>
  Express is an optional peer dependency of `@flowglad/server`. Install it alongside the server package to use Express utilities.
</Note>
