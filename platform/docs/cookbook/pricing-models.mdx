...
[Next.js](/cookbook/nextjs/generation-based-subscription) | [Tanstack Start](/cookbook/tanstack-start/generation-based-subscription) | [Vite](/cookbook/vite/generation-based-subscription) | [React Native](/cookbook/react-native/generation-based-subscription)
...
[Next.js](/cookbook/nextjs/tiered-usage-gated-subscription) 
...
[Next.js](/cookbook/nextjs/usage-limit-subscription) 
...
All pricing models can be defined in a `pricing.yaml` file. This file specifies:
...
This file can be imported/exported from Flowglad.


## Next Steps

<CardGroup cols={2}>
  <Card title="View a Next.js Example" icon="/images/nextjs.svg" href="/cookbook/nextjs/generation-based-subscription">
    See a generation based subscription example in Next.js
  </Card>
  <Card title="View a Vite Example" icon="/images/vite.svg" href="/cookbook/vite/generation-based-subscription">
    See a generation based subscription example in Vite + React
  </Card>
