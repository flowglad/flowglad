...
export const FAQSearch = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      body: (
        <>
          You can monitor service status at <a href="https://status.flowglad.com">https://status.flowglad.com</a>.
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          Flowglad supports countries where Stripe can onboard merchants via Stripe Connect. See the docs for the current list of supported countries and currencies.
        </>
      ),
    },
    {
