...
<CardGroup cols={2}>
  <Card title="SDK Documentation" icon="code" href="/sdks/introduction">
    Learn how to integrate these features using our SDKs.
  </Card>
  <Card title="API Reference" icon="book" href="/api-reference/introduction">
    Explore the full API documentation for direct integrations.
  </Card>
</CardGroup>
