...
Downgrades are handled automatically when scheduled for the end of the billing period (the default behavior). Flowglad validates capacity and manages claims for you:
