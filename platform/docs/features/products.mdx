...
Products allow you to group features together to form an offering your customers can purchase. Every product must be attached to exactly one pricing model and has one default active price at a time. 
...
- **Features** (for non-usage price types): The features included in this product
...
<Note>
Pricing Models group your products and prices. They are the bedrock of our multi-tenant pricing.
</Note>
...
- The invariant of one default active price per product always holds
