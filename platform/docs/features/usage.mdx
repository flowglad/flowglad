...
1.  Navigate to the [Pricing Models](https://app.flowglad.com/store/pricing-models) page in you dashboard and select the pricing model you would like to create the usage meter in.
