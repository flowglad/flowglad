---
title: 'How Flowglad Works'
description: 'Breaking down how data flows in Flowglad'
---

Beyond running payments, Flowglad takes the work of modeling and storing billing state off of your plate. Typically, you are left on your own to store a second copy of your billing data in your database, and keep it in sync with your payments processor via webhooks.

Flowglad models and stores this billing data for you, so you don't need to do all this. Instead, billing state is a natural extension of your auth model: Flowglad gives you a way to get the billing state for each of your customers based on who is logged in for a given session or request. Whenever you need billing data, you just request it from Flowglad.

## Data Flow

Flowglad is a full-data provider.
