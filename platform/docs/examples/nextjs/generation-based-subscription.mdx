...
flowchart TB
    subgraph UsageMeters["USAGE METERS"]
        meter1["fast_generations<br/>(sum aggregation)"]
        meter2["hd_video_minutes<br/>(sum aggregation)"]
    end

    subgraph Subscriptions["MONTHLY PLANS"]
        free["**Free** $0/mo<br/>No credits"]
        basic["**Basic** $10/mo<br/>200 fast generations"]
        standard["**Standard** $30/mo<br/>360 fast generations<br/>30 HD video minutes<br/>+ Unlimited Relaxed"]
        pro["**Pro** $60/mo<br/>750 fast generations<br/>60 HD video minutes<br/>+ Stealth Mode"]
        mega["**Mega** $120/mo<br/>900+ fast generations<br/>120 HD video minutes<br/>+ All features"]
    end

    subgraph TopUps["ONE TIME TOP-UPS"]
        topup1["**Fast Generations** $4<br/>+80 credits"]
        topup2["**HD Video Minutes** $10<br/>+10 minutes"]
    end
