...
[Next.js](/examples/nextjs/generation-based-subscription) | [Tanstack Start](/examples/tanstack-start/generation-based-subscription) | [Vite](/examples/vite/generation-based-subscription) | [React Native](/examples/react-native/generation-based-subscription)
...
[Next.js](/examples/nextjs/tiered-usage-gated-subscription) 
...
[Next.js](/examples/nextjs/usage-limit-subscription) 
...
<CardGroup cols={2}>
  <Card title="View a Next.js Example" icon="/images/nextjs.svg" href="/examples/nextjs/generation-based-subscription">
    See a generation based subscription example in Next.js
  </Card>
  <Card title="View a Vite Example" icon="/images/vite.svg" href="/examples/vite/generation-based-subscription">
