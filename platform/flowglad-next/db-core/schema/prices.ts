...
import { CurrencyCode, IntervalUnit, PriceType } from '../enums'
import {
 ...
 * @throws Error if slug uses reserved suffix
 */
export const validateUsagePriceSlug = (price: {
  ...
  if (
    ...
    throw new Error(
      `Usage price slugs ending with "${RESERVED_USAGE_PRICE_SLUG_SUFFIX}" are reserved for auto-generated fallback prices`
    )
  }
}
