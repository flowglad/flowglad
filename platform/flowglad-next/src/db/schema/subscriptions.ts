...
const standardSubscriptionStatuses = R.omit(
  ['CreditTrial'],
  SubscriptionStatus
)

const standardColumnRefinements = {
  status: z.nativeEnum(standardSubscriptionStatuses),
...
const creditTrialColumnRefinements = {
...
const standardSubscriptionSelectSchema = baseSelectSchema.extend(
  standardColumnRefinements
)

const creditTrialSubscriptionSelectSchema = baseSelectSchema.extend(
  creditTrialColumnRefinements
)
