...
> = {
  ...
  products_pricing_model_id_default_unique_idx:
    'This pricing model already has a default product. Only one default product is allowed per pricing model.',
  products_external_id_unique_idx:
    'A product with this external ID already exists.',
  products_slug_key:
    'A product with this slug already exists. Please choose a different slug.',
  products_organization_id_external_id_key:
    'A product with this external ID already exists in your organization.',
  products_pricing_model_id_fkey:
    'The specified pricing model does not exist or is not accessible.',
  ...
  customers_organization_id_external_id_unique_idx:
    'A customer with this external ID already exists in your organization.',
  customers_organization_id_invoice_number_base_unique_idx:
    'This invoice number base is already in use by another customer in your organization.',
  customers_stripe_customer_id_unique_idx:
    'This Stripe customer ID is already linked to another customer.',
  customers_email_key:
    'A customer with this email address already exists.',
  customers_organization_id_email_livemode_idx:
    'A customer with this email already exists in this environment.',
  customers_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  customers_pricing_model_id_fkey:
    'The specified pricing model does not exist or is not active.',

  // ============================================
  // PRICES CONSTRAINTS
  // ============================================
  prices_product_id_slug_unique_idx:
    'This price slug already exists for this product. Please choose a different slug.',
  prices_product_id_is_default_unique_idx:
    'This product already has a default price. Only one default price is allowed per product.',
  prices_product_id_fkey:
    'The specified product does not exist or is not available.',
  prices_overage_price_id_fkey:
    'The specified overage price does not exist.',
  prices_usage_meter_id_fkey:
    'The specified usage meter does not exist or is not configured.',

  // ============================================
  // SUBSCRIPTIONS CONSTRAINTS
  // ============================================
  subscriptions_external_id_unique_idx:
    'A subscription with this external ID already exists.',
  subscriptions_customer_id_fkey:
    'The specified customer does not exist or has been deleted.',
  subscriptions_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  subscriptions_payment_method_id_fkey:
    'The specified payment method does not exist or is not valid.',
  active_subscription_per_customer:
    'This customer already has an active subscription. Cancel or modify the existing subscription first.',

  // ============================================
  // SUBSCRIPTION ITEMS CONSTRAINTS
  // ============================================
  subscription_items_external_id_unique_idx:
    'A subscription item with this external ID already exists.',
  subscription_items_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',
  subscription_items_price_id_fkey:
    'The specified price does not exist or is not active.',

  // ============================================
  // INVOICES CONSTRAINTS
  // ============================================
  invoices_invoice_number_unique_idx:
    'An invoice with this number already exists. Invoice numbers must be unique.',
  invoices_purchase_id_fkey: 'The specified purchase does not exist.',
  invoices_billing_period_id_fkey:
    'The specified billing period does not exist.',
  ...
  invoices_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',
  invoices_billing_run_id_fkey:
    'The specified billing run does not exist.',
  invoices_owner_membership_id_fkey:
    'The specified membership does not exist.',
  ...
  invoice_line_items_price_id_fkey:
    'The specified price does not exist or is not active.',
  invoice_line_items_billing_run_id_fkey:
    'The specified billing run does not exist.',
  invoice_line_items_ledger_account_id_fkey:
    'The specified ledger account does not exist.',

  // ============================================
  // PAYMENT METHODS CONSTRAINTS
  // ============================================
  payment_methods_external_id_unique_idx:
    'A payment method with this external ID already exists.',
  ...
  payments_stripe_charge_id_unique_idx:
    'A payment with this Stripe charge ID already exists.',
  payments_invoice_id_fkey: 'The specified invoice does not exist.',
  payments_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  ...
  // ============================================
  features_organization_id_slug_unique_idx:
    'A feature with this slug already exists in your organization.',
  features_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  ...
  product_features_product_id_feature_id_unique_idx:
    'This feature is already linked to this product.',
  product_features_product_id_fkey:
    'The specified product does not exist or is not available.',
  ...
  // ============================================
  usage_meters_pricing_model_id_slug_unique_idx:
    'A usage meter with this slug already exists in this pricing model.',
  usage_meters_pricing_model_id_fkey:
    'The specified pricing model does not exist or is not active.',
  usage_meters_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  ...
  usage_events_idempotency_key_unique_idx:
    'An event with this idempotency key already exists. Each event must have a unique key.',
  usage_events_customer_id_fkey:
    'The specified customer does not exist or has been deleted.',
  usage_events_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  usage_events_usage_meter_id_fkey:
    'The specified usage meter does not exist or is not configured.',
  usage_events_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',

  // ============================================
  // LEDGER ACCOUNTS CONSTRAINTS
  // ============================================
  ledger_accounts_organization_id_subscription_id_usage_meter_id_unique_idx:
    'A ledger account already exists for this subscription and usage meter combination.',
  ledger_accounts_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  ledger_accounts_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',
  ledger_accounts_usage_meter_id_fkey:
    'The specified usage meter does not exist or is not configured.',

  // ============================================
  // LEDGER TRANSACTIONS CONSTRAINTS
  // ============================================
  ledger_transactions_ledger_account_id_sequence_number_unique_idx:
    'A transaction with this sequence number already exists for this ledger account.',
  ledger_transactions_idempotency_key_unique_idx:
    'A transaction with this idempotency key already exists.',
  ledger_transactions_ledger_account_id_fkey:
    'The specified ledger account does not exist.',
  ...
  ledger_entries_ledger_transaction_id_fkey:
    'The specified ledger transaction does not exist.',
  ledger_entries_ledger_account_id_fkey:
    'The specified ledger account does not exist.',

  // ============================================
  // BILLING PERIODS CONSTRAINTS
  // ============================================
  billing_periods_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',
  billing_periods_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",

  // ============================================
  // BILLING PERIOD ITEMS CONSTRAINTS
  // ============================================
  billing_period_items_billing_period_id_fkey:
    'The specified billing period does not exist.',
  billing_period_items_price_id_fkey:
    'The specified price does not exist or is not active.',

  // ============================================
  // BILLING RUNS CONSTRAINTS
  // ============================================
  billing_runs_billing_period_id_fkey:
    'The specified billing period does not exist.',
  billing_runs_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',
  billing_runs_payment_method_id_fkey:
    'The specified payment method does not exist or is not valid.',

  // ============================================
  // DISCOUNTS CONSTRAINTS
  // ============================================
  discounts_code_unique_idx:
    'A discount with this code already exists.',
  discounts_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",

  // ============================================
  // DISCOUNT REDEMPTIONS CONSTRAINTS
  // ============================================
  discount_redemptions_discount_id_fkey:
    'The specified discount does not exist or has expired.',
  discount_redemptions_customer_id_fkey:
    'The specified customer does not exist or has been deleted.',
  discount_redemptions_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',

  // ============================================
  // PURCHASES CONSTRAINTS
  // ============================================
  purchases_customer_id_fkey:
    'The specified customer does not exist or has been deleted.',
  purchases_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  purchases_price_id_fkey:
    'The specified price does not exist or is not active.',
  purchases_payment_method_id_fkey:
    'The specified payment method does not exist or is not valid.',
  ...
  purchase_access_sessions_purchase_id_fkey:
  ...
  refunds_payment_id_fkey:
    'The specified payment does not exist or cannot be refunded.',
  refunds_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  ...
  organizations_external_id_unique_idx:
    'An organization with this external ID already exists.',
  ...
  files_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  files_product_id_fkey:
    'The specified product does not exist or is not available.',
  ...
  events_hash_unique_idx:
    'An event with this hash already exists. This may be a duplicate event.',

  // ============================================
  // MESSAGES CONSTRAINTS
  // ============================================
  messages_customer_id_slug_unique_idx:
    'A message with this slug already exists for this customer.',
  ...
  // ============================================
  proper_nouns_organization_id_entity_type_entity_id_unique_idx:
    'A proper noun already exists for this entity.',
  proper_nouns_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",

  // ============================================
  // WEBHOOKS CONSTRAINTS
  // ============================================
  webhooks_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",

  // ============================================
  // CHECKOUT SESSIONS CONSTRAINTS
  // ============================================
  checkout_sessions_customer_id_fkey:
    'The specified customer does not exist or has been deleted.',
  checkout_sessions_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  ...
  // ============================================
  pricing_models_organization_id_slug_unique_idx:
    'A pricing model with this slug already exists in your organization.',
  pricing_models_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  pricing_models_created_by_user_id_fkey:
    'The specified user does not exist.',

  // ============================================
  // SUBSCRIPTION ITEM FEATURES CONSTRAINTS
  // ============================================
  subscription_item_features_subscription_item_id_feature_id_unique_idx:
    'This feature is already linked to this subscription item.',
  subscription_item_features_subscription_item_id_fkey:
    'The specified subscription item does not exist.',
  subscription_item_features_feature_id_fkey:
    'The specified feature does not exist.',
  ...
  subscription_meter_period_calculations_active_calculation_uq:
    'An active calculation already exists for this subscription and meter period.',
  subscription_meter_period_calculations_subscription_id_fkey:
    'The specified subscription does not exist or has been cancelled.',
  subscription_meter_period_calculations_usage_meter_id_fkey:
    'The specified usage meter does not exist or is not configured.',

  // ============================================
  // USAGE CREDITS CONSTRAINTS
  // ============================================
  usage_credits_ledger_account_id_fkey:
    'The specified ledger account does not exist.',
  usage_credits_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",

  // ============================================
  // USAGE CREDIT APPLICATIONS CONSTRAINTS
  // ============================================
  usage_credit_applications_usage_credit_id_fkey:
    'The specified usage credit does not exist or has been consumed.',
  usage_credit_applications_usage_event_id_fkey:
    'The specified usage event does not exist.',

  // ============================================
  // USAGE CREDIT BALANCE ADJUSTMENTS CONSTRAINTS
  // ============================================
  usage_credit_balance_adjustments_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
  usage_credit_balance_adjustments_adjusted_usage_credit_id_fkey:
    'The specified usage credit does not exist.',
  usage_credit_balance_adjustments_adjusted_by_user_id_fkey:
    'The specified user does not exist.',

  // ============================================
  // FEE CALCULATIONS CONSTRAINTS
  // ============================================
  fee_calculations_invoice_id_fkey:
    'The specified invoice does not exist.',
  fee_calculations_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",

  // ============================================
  // LINKS CONSTRAINTS
  // ============================================
  links_customer_id_fkey:
    'The specified customer does not exist or has been deleted.',
  links_price_id_fkey:
    'The specified price does not exist or is not active.',
  links_organization_id_fkey:
    "The specified organization does not exist or you don't have access to it.",
...
const RLS_ERROR_PATTERNS: Record<
  string,
  {
    pattern: RegExp
    userMessage: string
...
> = {
  organization_membership: {
    pattern:
      /row-level security.*memberships|permission denied.*organization/i,
    userMessage:
      'This operation could not be completed. Please ensure you have the necessary permissions.',
    internalNote: 'RLS: Organization membership check failed',
  },
  customer_access: {
    pattern:
      /row-level security.*customers|permission denied.*customer/i,
    userMessage:
  ...
  livemode_mismatch: {
    ...
    userMessage:
      'This operation cannot be performed in the current environment mode.',
    internalNote:
      'RLS: Livemode mismatch - attempting to access different environment data',
  },
  subscription_access: {
    pattern: /row-level security.*subscriptions/i,
    userMessage:
      'Unable to access this subscription. Please verify your permissions.',
    internalNote: 'RLS: Subscription access denied',
  },
  product_access: {
    pattern: /row-level security.*products/i,
    userMessage:
      'Unable to access this product. Please verify your organization permissions.',
    internalNote: 'RLS: Product organization access denied',
  },
  invoice_access: {
    pattern: /row-level security.*invoices/i,
    userMessage:
      'Unable to access this invoice. Please verify your permissions.',
    internalNote: 'RLS: Invoice access denied',
  },
  delete_forbidden: {
    pattern:
      /row-level security.*delete|Forbid deletion|Disallow deletion/i,
    userMessage:
      'This item cannot be deleted. Please contact support if you need to remove this record.',
    internalNote: 'RLS: Deletion is forbidden by policy',
  },
  generic_rls: {
    pattern:
      /row-level security|permission denied for (table|schema)/i,
    userMessage:
...
const RESOURCE_HELPFUL_CONTEXT: Record<
  string,
  Record<string, string>
> = {
  products: {
    slug_conflict:
      'Tip: Product slugs must be unique within each pricing model. Consider adding a number or variation to make it unique.',
    default_conflict:
      'Tip: Use the "Set as Default" option on an existing product instead of creating a new default.',
    external_id_conflict:
      'Tip: External IDs are used for integration with external systems. Ensure they are unique across your organization.',
  },
  customers: {
    email_conflict:
      'Tip: This email is already registered. You can search for the existing customer or use a different email.',
    external_id_conflict:
      "Tip: External IDs must be unique. If migrating data, ensure IDs don't conflict with existing records.",
    stripe_id_conflict:
      "Tip: This Stripe customer is already linked. Check if you're trying to create a duplicate customer.",
  },
  subscriptions: {
    active_conflict:
      'Tip: Cancel or pause the existing subscription before creating a new one for this customer.',
    payment_method_missing:
      'Tip: Ensure the customer has a valid payment method before creating a subscription.',
  },
  prices: {
    slug_conflict:
      'Tip: Price slugs must be unique within each product. Consider using descriptive names like "monthly-pro" or "annual-basic".',
    default_conflict:
      'Tip: Each product can have only one default price. Update the existing default price or remove its default status first.',
  },
  invoices: {
    number_conflict:
      'Tip: Invoice numbers must be unique. Consider using a sequential numbering system or adding a prefix.',
  },
  features: {
    slug_conflict:
      'Tip: Feature slugs are used in API calls. Use lowercase with hyphens, like "api-access" or "priority-support".',
  },
}
...
const ERROR_CODE_MESSAGES: Record<
  string,
  string | ((error: PostgresError) => string)
> = {
  ...
  '23503': (error: PostgresError) => {
    ...
    if (
      error.column_name &&
      FOREIGN_KEY_FIELD_MESSAGES[error.column_name]
    ) {
  ...
  // Data Exception
  '22001':
    'The provided text is too long. Please shorten your input.',
  '22003': 'The number provided is out of range.',
  '22007': 'Invalid date format. Please provide a valid date.',
  '22P02':
    'Invalid text representation. Please check your input format.',
  '22012': 'Division by zero error.',
  '22005':
    "Error in assignment. The value type doesn't match the expected type.",
  ...
  '08004':
    'Database connection rejected. Please check your credentials.',

  // Transaction Rollback
  '40001':
    'Operation failed due to concurrent update. Please try again.',
  ...
  HV000:
    'Foreign data wrapper error. Please check external connections.',
}
...
function getHelpfulContext(error: PostgresError): string | null {
  ...
  if (RESOURCE_HELPFUL_CONTEXT[table]) {
    if (
      ...
      RESOURCE_HELPFUL_CONTEXT[table]['slug_conflict']
    ) {
      return RESOURCE_HELPFUL_CONTEXT[table]['slug_conflict']
    }
    if (
      constraint.includes('default') &&
      RESOURCE_HELPFUL_CONTEXT[table]['default_conflict']
    ) {
      return RESOURCE_HELPFUL_CONTEXT[table]['default_conflict']
    }
    if (
      constraint.includes('external_id') &&
      RESOURCE_HELPFUL_CONTEXT[table]['external_id_conflict']
    ) {
      return RESOURCE_HELPFUL_CONTEXT[table]['external_id_conflict']
    }
    if (
      constraint.includes('email') &&
      RESOURCE_HELPFUL_CONTEXT[table]['email_conflict']
    ) {
...
export function parsePostgresError(error: unknown): {
  ...
  if (error instanceof Error) {
    ...
    if (
      ...
      const slugMatch = error.message.match(
        /"slug"\s*=\s*\$\d+.*params:.*?,\s*'([^']+)'/i
      )
      if (slugMatch) {
...
export function isRLSError(error: unknown): boolean {
  ...
  return /row-level security|permission denied for (table|schema)|check mode/i.test(
    fullError
  )
}
