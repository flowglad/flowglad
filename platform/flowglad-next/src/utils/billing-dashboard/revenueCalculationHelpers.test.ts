...
describe('Edge Cases and Error Handling', () => {
  it('should handle leap day (February 29) in billing periods', () => {
    ...
    const leapYearBillingPeriod: BillingPeriod.Record = {
      ...
      startDate: new Date('2024-02-01T05:00:00.000Z'),
      endDate: new Date('2024-02-29T05:00:00.000Z'),
      status: BillingPeriodStatus.Active,
      trialPeriod: false,
      livemode: false,
      createdAt: new Date(),
    ...
    const spanningLeapMonthBillingPeriod: BillingPeriod.Record = {
      id: 'spanning-leap-bp',
      subscriptionId: 'sub-1',
      startDate: new Date('2024-01-15T05:00:00.000Z'),
      endDate: new Date('2024-02-15T05:00:00.000Z'),
      status: BillingPeriodStatus.Active,
      trialPeriod: false,
      livemode: false,
      createdAt: new Date(),
  ...
  it('should handle billing periods spanning multiple years', () => {
    const multiYearBillingPeriod: BillingPeriod.Record = {
      ...
      subscriptionId: 'sub-1',
      startDate: new Date('2023-01-01T05:00:00.000Z'),
      endDate: new Date('2025-12-31T05:00:00.000Z'),
      status: BillingPeriodStatus.Active,
      trialPeriod: false,
      livemode: false,
      createdAt: new Date(),
