...
//     it('should throw an error when the source catalog does not exist', async () => {
//       await expect(
//         adminTransaction(async ({ transaction }) => {
//           return cloneCatalogTransaction(
//             {
//               sourceCatalogId: 'non-existent-id',
//               name: 'Cloned Catalog',
//             },
//             transaction
//           )
...
//           return cloneCatalogTransaction(
//             {
//               sourceCatalogId: emptyCatalog.id,
...
//       const transaction = await adminTransaction(
//         async ({ transaction }) => {
//           return transaction
//         }
//       )

//       const clonedCatalog = await cloneCatalogTransaction(
//         {
//           sourceCatalogId: sourceCatalog.id,
//           name: 'Cloned Catalog',
//         },
