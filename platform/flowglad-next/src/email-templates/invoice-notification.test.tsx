...
import { InvoiceNotificationEmail } from './invoice-notification'

describe('InvoiceNotificationEmail', () => {
  ...
  describe('basic rendering', () => {
    it('should render the email template with invoice details', () => {
      const { getByTestId, getByText } = render(
        <InvoiceNotificationEmail {...mockProps} />
      )
    ...
    it('should render without organization logo when not provided', () => {
      ...
      const { queryByAltText } = render(
        <InvoiceNotificationEmail {...propsWithoutLogo} />
      )
  ...
  describe('MoR Support', () => {
    describe('when isMoR is false', () => {
      it('should render organization branding', () => {
        const { getByAltText } = render(
          <InvoiceNotificationEmail {...mockProps} isMoR={false} />
        )
    ...
    describe('when isMoR is true', () => {
      it('should show Flowglad branding', () => {
        const { getByAltText } = render(
          <InvoiceNotificationEmail {...mockProps} isMoR={true} />
        )
