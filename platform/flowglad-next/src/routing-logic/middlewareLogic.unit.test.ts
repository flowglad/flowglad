...
describe('middlewareLogic', () => {
  describe('no session cookie scenarios', () => {
    describe('protected merchant route without merchant session', () => {
      ...
      it('should redirect to general sign-in for API routes when no merchant session', () => {
        const result = middlewareLogic({
          merchantSessionCookie: null,
          customerSessionCookie: null,
          isProtectedRoute: true,
      ...
      it('should redirect to merchant sign-in even if customer session exists (merchant route needs merchant session)', () => {
        const result = middlewareLogic({
          merchantSessionCookie: null,
    ...
    describe('protected billing portal route without customer session', () => {
      ...
      it('should redirect to customer sign-in even if merchant session exists (billing portal needs customer session)', () => {
        const result = middlewareLogic({
  ...
  describe('dual-session handling', () => {
    describe('merchant with customer session accessing merchant routes', () => {
      it('should allow merchant with both sessions to access merchant routes', () => {
        const result = middlewareLogic({
          merchantSessionCookie: 'valid_merchant_session',
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: true,
      ...
      it('should allow merchant with both sessions to access merchant API routes', () => {
        const result = middlewareLogic({
          merchantSessionCookie: 'valid_merchant_session',
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: true,
    ...
    describe('customer with merchant session accessing billing portal routes', () => {
      it('should allow customer with both sessions to access billing portal routes', () => {
        const result = middlewareLogic({
          merchantSessionCookie: 'valid_merchant_session',
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: true,
          pathName: '/billing-portal/org_456/cust_789/dashboard',
          req: {
            nextUrl:
              'https://example.com/billing-portal/org_456/cust_789/dashboard',
          },
        })
      ...
      it('should allow customer with both sessions to access customerBillingPortal TRPC routes', () => {
        const result = middlewareLogic({
          merchantSessionCookie: 'valid_merchant_session',
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: true,
  ...
  describe('session cookie exists scenarios', () => {
    describe('merchant routes with valid merchant session', () => {
      it('should proceed for protected merchant routes when merchant session exists', () => {
        const result = middlewareLogic({
          merchantSessionCookie: 'valid_merchant_session',
          customerSessionCookie: null,
          isProtectedRoute: true,
      ...
      it('should proceed for public routes when merchant session exists', () => {
        const result = middlewareLogic({
          merchantSessionCookie: 'valid_merchant_session',
          customerSessionCookie: null,
          isProtectedRoute: false,
    ...
    describe('billing portal routes with valid customer session', () => {
      it('should proceed when customer session exists for billing portal routes', () => {
        const result = middlewareLogic({
          merchantSessionCookie: null,
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: true,
          pathName: '/billing-portal/org_456/cust_789/settings',
          req: {
            nextUrl:
              'https://example.com/billing-portal/org_456/cust_789/settings',
          },
        })
      ...
      it('should proceed for customerBillingPortal TRPC routes when customer session exists', () => {
        const result = middlewareLogic({
          merchantSessionCookie: null,
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: true,
      ...
      it('should proceed for public routes when customer session exists', () => {
        const result = middlewareLogic({
          merchantSessionCookie: null,
          customerSessionCookie: 'valid_customer_session',
          isProtectedRoute: false,
  ...
  describe('edge cases', () => {
    it('should handle empty merchantSessionCookie string as no session for merchant routes', () => {
      const result = middlewareLogic({
    ...
    it('should handle empty customerSessionCookie string as no session for billing portal routes', () => {
      const result = middlewareLogic({
        merchantSessionCookie: null,
    ...
    it('should handle undefined merchantSessionCookie as no session', () => {
      const result = middlewareLogic({
    ...
    it('should handle billing portal path exactly at root with valid customer session', () => {
      const result = middlewareLogic({
        merchantSessionCookie: null,
        customerSessionCookie: 'valid_customer_session',
        isProtectedRoute: true,
