    ...
    return (
      <div className={cn('relative', className)}>
        <textarea
          ...
          className={cn(
            'flex min-h-[80px] w-full rounded-2xl border border-input bg-card px-3 py-2 text-base transition-colors placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/20 focus-visible:border-foreground disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
            textareaClassName
          )}
          {...props}
        />
