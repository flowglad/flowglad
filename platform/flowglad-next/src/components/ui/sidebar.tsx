  ...
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg py-3 px-3 text-left text-sm font-normal outline-none ring-sidebar-ring transition-[width,height,padding,opacity] duration-150 ease opacity-80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:pl-[12px] hover:opacity-100 focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground data-[active=true]:opacity-100 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground data-[state=open]:hover:pl-[13px] group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2.5 [&>span:last-child]:truncate [&>svg]:size-[18px] [&>svg]:shrink-0 [&>svg]:stroke-[1.75] group-data-[collapsible=icon]:[&>span]:opacity-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'bg-sidebar shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:pl-[13px] hover:opacity-100 hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]',
      },
      size: {
