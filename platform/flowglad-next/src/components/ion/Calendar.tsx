...
// Figma Link: https://www.figma.com/design/3fYHKpBnD7eYSAmfSvPhvr?node-id=286:9166
// ion/DatePicker/Calendar: Generated with Ion on 10/11/2024, 4:12:34 AM
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          'text-muted-foreground rounded-radius w-9 font-normal text-sm',
        ...
        day_outside:
          'day-outside text-muted-foreground aria-selected:text-on-primary',
