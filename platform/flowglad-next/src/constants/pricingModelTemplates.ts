      ...
      products: [
        ...
        },
        {
          ...
          prices: [
            ...
            {
              type: PriceType.Usage,
              slug: 'plus_gpt5_thinking_overage',
              isDefault: false,
              name: 'GPT-5 Thinking Message Overage',
              usageMeterSlug: 'gpt_5_thinking_messages',
              trialPeriodDays: null,
              usageEventsPerUnit: 1,
              active: true,
            ...
            {
              type: PriceType.Usage,
              slug: 'plus_o3_overage',
              isDefault: false,
              name: 'o3 Message Overage',
              usageMeterSlug: 'o3_messages',
              trialPeriodDays: null,
              usageEventsPerUnit: 1,
              active: true,
            ...
            {
              type: PriceType.Usage,
              slug: 'plus_o4_mini_overage',
              isDefault: false,
              name: 'o4-mini Message Overage',
              usageMeterSlug: 'o4_mini_messages',
              trialPeriodDays: null,
              usageEventsPerUnit: 1,
              active: true,
            ...
            {
              type: PriceType.Usage,
              slug: 'plus_o4_mini_high_overage',
              isDefault: false,
              name: 'o4-mini-high Message Overage',
              usageMeterSlug: 'o4_mini_high_messages',
              trialPeriodDays: null,
              usageEventsPerUnit: 1,
              active: true,
            ...
            {
              type: PriceType.Usage,
              slug: 'plus_agent_mode_overage',
              isDefault: false,
              name: 'Agent Mode Message Overage',
              usageMeterSlug: 'agent_messages',
              trialPeriodDays: null,
              usageEventsPerUnit: 1,
              active: true,
            ...
            {
              type: PriceType.Usage,
              slug: 'plus_deep_research_overage',
              isDefault: false,
              name: 'Deep Research Request Overage',
              usageMeterSlug: 'deep_research_requests',
              trialPeriodDays: null,
              usageEventsPerUnit: 1,
              active: true,
        ...
        },
        {
          product: {
            ...
            default: false,
            description:
              'Tool for tracking o3 usage events on unlimited plan',
            slug: 'o3_tracking',
            active: true,
            imageURL: null,
            singularQuantityLabel: null,
        ...
        },
        {
          product: {
            ...
            default: false,
            description:
              'Tool for tracking o4-mini usage events on unlimited plan',
        ...
        },
        {
          product: {
            ...
            default: false,
            description:
              'Tool for tracking o4-mini-high usage events on unlimited plan',
