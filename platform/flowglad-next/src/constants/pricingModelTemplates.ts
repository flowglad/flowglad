...
export const UNLIMITED_USAGE_SUBSCRIPTION_TEMPLATE: PricingModelTemplate =
  {
    ...
    input: {
      ...
      usageMeters: [
        {
          slug: 'gpt-5-thinking-messages',
          name: 'GPT-5 Thinking Messages',
        },
        { slug: 'o3-messages', name: 'o3 Messages' },
        { slug: 'o4-mini-messages', name: 'o4-mini Messages' },
        {
          slug: 'o4-mini-high-messages',
          name: 'o4-mini-high Messages',
        },
        { slug: 'agent-messages', name: 'Agent Mode Messages' },
        {
          slug: 'deep-research-requests',
      ...
      features: [
        ...
        },
        {
          ...
          usageMeterSlug: 'o4-mini-messages',
          amount: 300,
          renewalFrequency:
            FeatureUsageGrantFrequency.EveryBillingPeriod,
          active: true,
...
export const AI_IMAGE_GENERATION_SUBSCRIPTION_TEMPLATE: PricingModelTemplate =
  {
    metadata: {
      id: 'ai-image-generation-subscription',
    ...
    input: {
      ...
      features: [
        ...
        {
          type: FeatureType.UsageCreditGrant,
          slug: 'standard-fast-generations',
        ...
        {
          type: FeatureType.Toggle,
          slug: 'unlimited-relaxed-sd-video',
        ...
        {
          type: FeatureType.Toggle,
          slug: 'use-within-upgraded-images',
      ...
      products: [
        ...
        },
        {
          ...
          features: [
            'standard-fast-generations',
            'standard-hd-video-minutes',
            'general-commercial-terms',
            'optional-credit-top-ups',
            'relax-mode-included',
            'unlimited-relaxed-images',
            'use-within-upgraded-images',
          ],
        ...
        },
        {
          ...
          features: [
            'pro-fast-generations',
            'pro-hd-video-minutes',
            'general-commercial-terms',
            'optional-credit-top-ups',
            'relax-mode-included',
        ...
        },
        {
          ...
          features: [
            'mega-fast-generations',
            'mega-hd-video-minutes',
            'general-commercial-terms',
            'optional-credit-top-ups',
            'relax-mode-included',
            'unlimited-relaxed-sd-video',
...
export const AI_MEETING_NOTES_SUBSCRIPTION_TEMPLATE: PricingModelTemplate =
  {
    metadata: {
      id: 'ai-meeting-notes-subscription',
...
/**
 * AI Request Credits Template
 * Recommended for: AI Value-Add Tools
 * Model: Request-based pricing with monthly API call credits.
 */
export const AI_REQUEST_CREDITS_TEMPLATE: PricingModelTemplate = {
  metadata: {
    id: 'ai-request-credits',
    title: 'AI Request Credits',
    description:
      'Request-based pricing for AI tools. Monthly plans include API request credits with pay-per-use overages. Perfect for AI-powered applications.',
    icon: Radio,
    features: [
      {
        icon: Activity,
        text: 'Request-based pricing',
      },
      {
        icon: Recycle,
        text: 'Credits refresh monthly',
      },
      {
        icon: Zap,
        text: 'Flexible overage pricing',
      },
    ],
    usedBy: {
      name: 'Recommended for AI Tools',
      logo: '',
    },
  },
  input: {
    ...
    features: [
      {
        type: FeatureType.UsageCreditGrant,
        slug: 'starter-requests',
        name: '1,000 API Requests',
        description: '1,000 API requests included per month',
      ...
      {
        type: FeatureType.UsageCreditGrant,
        slug: 'growth-requests',
        name: '10,000 API Requests',
        description: '10,000 API requests included per month',
        usageMeterSlug: 'api-requests',
        amount: 10000,
        renewalFrequency:
          FeatureUsageGrantFrequency.EveryBillingPeriod,
      ...
      },
      {
        type: FeatureType.UsageCreditGrant,
        slug: 'scale-requests',
        name: '50,000 API Requests',
        description: '50,000 API requests included per month',
        usageMeterSlug: 'api-requests',
        amount: 50000,
        renewalFrequency:
          FeatureUsageGrantFrequency.EveryBillingPeriod,
      ...
      },
      {
        ...
        description: 'Premium AI features and integrations',
        active: true,
      },
      {
        type: FeatureType.Toggle,
    ...
    products: [
      {
        product: {
          name: 'Free',
          default: true,
          description: 'Get started with 100 requests per month',
          slug: 'free-tier',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      },
      {
        product: {
          name: 'Starter',
          default: false,
          description: '$29/mo with 1,000 requests included',
          slug: 'starter-monthly',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      },
      {
        product: {
          name: 'Starter',
          default: false,
          description: '$348/yr with 1,000 requests included',
          slug: 'starter-yearly',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      },
      {
        product: {
          name: 'Growth',
          default: false,
          description: '$99/mo with 10K requests + advanced features',
          slug: 'growth-monthly',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      },
      {
        product: {
          ...
          default: false,
          description:
            '$1,188/yr with 10K requests + advanced features',
          slug: 'growth-yearly',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      },
      {
        product: {
          name: 'Scale',
          default: false,
          description: '$399/mo with 50K requests + premium support',
          slug: 'scale-monthly',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      },
      {
        product: {
          ...
          default: false,
          description:
            '$4,788/yr with 50K requests + premium support',
          slug: 'scale-yearly',
          active: true,
          imageURL: null,
          singularQuantityLabel: null,
      ...
      {
        product: {
          name: 'Request Overages',
          default: false,
          description:
            'Additional requests billed per-use after included credits exhausted',
          slug: 'request-overages',
          active: true,
          imageURL: null,
          singularQuantityLabel: 'request',
          pluralQuantityLabel: 'requests',
