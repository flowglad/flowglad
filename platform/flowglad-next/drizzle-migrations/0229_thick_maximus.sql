...
CREATE POLICY "Enable read for own organizations" ON "organizations" AS PERMISSIVE FOR SELECT TO "authenticated" USING (id IN ( SELECT memberships.organization_id
   FROM memberships
