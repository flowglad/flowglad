...
DO $$ BEGIN
    CREATE TYPE "UsageCreditSourceReferenceType" AS ENUM ('payment', 'manual_adjustment');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
...
ALTER TABLE "ledger_entries" ADD COLUMN "expired_at_usage_transaction_id" text;--> statement-breakpoint
ALTER TABLE "usage_transactions" ADD COLUMN "subscription_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "usage_transactions" ADD COLUMN "usage_meter_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "usage_transactions" ADD COLUMN "idempotency_key" text;--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ledger_entries" ADD CONSTRAINT "ledger_entries_usage_transaction_id_usage_transactions_id_fk" FOREIGN KEY ("usage_transaction_id") REFERENCES "public"."usage_transactions"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ledger_entries" ADD CONSTRAINT "ledger_entries_expired_at_usage_transaction_id_usage_transactions_id_fk" FOREIGN KEY ("expired_at_usage_transaction_id") REFERENCES "public"."usage_transactions"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "usage_transactions" ADD CONSTRAINT "usage_transactions_subscription_id_subscriptions_id_fk" FOREIGN KEY ("subscription_id") REFERENCES "public"."subscriptions"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "usage_transactions" ADD CONSTRAINT "usage_transactions_usage_meter_id_usage_meters_id_fk" FOREIGN KEY ("usage_meter_id") REFERENCES "public"."usage_meters"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "ledger_entries_usage_transaction_id_idx" ON "ledger_entries" USING btree ("usage_transaction_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "usage_transactions_usage_meter_id_idx" ON "usage_transactions" USING btree ("usage_meter_id");--> statement-breakpoint
