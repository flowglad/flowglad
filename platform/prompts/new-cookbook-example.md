...
- File `cookbook/nextjs/generation-based-subscription.mdx` corresponds to `/cookbook/nextjs/generation-based-subscription`
...
- `/cookbook/pricing-models` - Pricing models overview
